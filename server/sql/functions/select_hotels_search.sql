CREATE OR REPLACE FUNCTION select_hotels_search(
    ...
    BEGIN
         RETURN QUERY
        	SELECT hotels.name, MIN(room.price) AS price,hotels.country, hotels.city, hotels.address,hotels.user_rating, hotels.stars, service_of_rooms.double_bed , service_of_rooms.single_bed, service_of_rooms.free_cancel ,hotels_photos.h_photos_path
		FROM hotels
